...
TFile * outputFile = new TFile((inFolder+prefix+filename).c_str(), "RECREATE");
  ...
  // Create a TCanvas.                                                         
  TCanvas* c1 = new TCanvas("c1","Data Exploration Taus",200,10,600,400);
  TCanvas* c2 = new TCanvas("c2","Data Exploration Jets",200,10,600,400);
...
void histogramsByType(std::string filename){
  ...
  c1->cd(16); h16->Draw("hist"); h1016->SetLineColor(kRed); h1016->Draw("hist same");
  c1->cd(17); h17->Draw("hist"); h1017->SetLineColor(kRed); h1017->Draw("hist same");
  c1->cd(18); h18->Draw("hist"); h1018->SetLineColor(kRed); h1018->Draw("hist same");
  c1->cd(19); h19->Draw("hist"); h1019->SetLineColor(kRed); h1019->Draw("hist same");
  c1->cd(20); h20->Draw("hist"); h1020->SetLineColor(kRed); h1020->Draw("hist same");
  c1->cd(21); h21->Draw("hist"); h1021->SetLineColor(kRed); h1021->Draw("hist same");
  c1->cd(22); h22->Draw("hist"); h1022->SetLineColor(kRed); h1022->Draw("hist same");
  c1->cd(23); h23->Draw("hist"); h1023->SetLineColor(kRed); h1023->Draw("hist same");
  c1->cd(0);
  c1->Print((inFolder+prefix+filename+sufix1).c_str());
  /*
  ...
  */
  ...
  c2->cd(4); h33->Draw("hist"); h1033->SetLineColor(kRed); h1033->Draw("hist same");
  c2->cd(5); h34->Draw("hist"); h1034->SetLineColor(kRed); h1034->Draw("hist same");
  c2->cd(6); h35->Draw("hist"); h1035->SetLineColor(kRed); h1035->Draw("hist same");
  c2->cd(7); h36->Draw("hist"); h1036->SetLineColor(kRed); h1036->Draw("hist same");
  c2->cd(8); h37->Draw("hist"); h1037->SetLineColor(kRed); h1037->Draw("hist same");
  c2->cd(9); h38->Draw("hist"); h1038->SetLineColor(kRed); h1038->Draw("hist same");
  c2->cd(10); h39->Draw("hist"); h1039->SetLineColor(kRed); h1039->Draw("hist same");
  c2->cd(11); h40->Draw("hist"); h1040->SetLineColor(kRed); h1040->Draw("hist same");
  c2->cd(12); h41->Draw("hist"); h1041->SetLineColor(kRed); h1041->Draw("hist same");
  c2->cd(13); h42->Draw("hist"); h1042->SetLineColor(kRed); h1042->Draw("hist same");
  c2->cd(14); h43->Draw("hist"); h1043->SetLineColor(kRed); h1043->Draw("hist same");
  c2->cd(15); h44->Draw("hist"); h1044->SetLineColor(kRed); h1044->Draw("hist same");
  c2->cd(16); h45->Draw("hist"); h1045->SetLineColor(kRed); h1045->Draw("hist same");
  c2->cd(17); h46->Draw("hist"); h1046->SetLineColor(kRed); h1046->Draw("hist same");
  ...
  c2->cd(26); h55->Draw("hist"); h1055->SetLineColor(kRed); h1055->Draw("hist same");
  c2->cd(27); h56->Draw("hist"); h1056->SetLineColor(kRed); h1056->Draw("hist same");
  c2->cd(28); h57->Draw("hist"); h1057->SetLineColor(kRed); h1057->Draw("hist same");
