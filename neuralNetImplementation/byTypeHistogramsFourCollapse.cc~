...
void byTypeHistogramsThreeCollapse(){

  gROOT->Reset();
  gStyle->SetOptStat(0); 
  // Load input data                                                           
  TFile * inputFile = new TFile("threeCollapsedROOTNtuples/collapsedTree.root", "READ");
  ...
  */
  ...
  c1->cd(0);
  c1->Print("threeCollapsedROOTNtuples/TausByType.pdf");
  ...
  c2->cd(0);
  c2->Print("threeCollapsedROOTNtuples/MissByType.pdf");
  ...
  c3->cd(0);
  c3->Print("threeCollapsedROOTNtuples/JetsByType.pdf");
