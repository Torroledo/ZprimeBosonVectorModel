...
void byTypeHistogramsTwoCollapse(){

  gROOT->Reset();
  gStyle->SetOptStat(0); 
  // Load input data                                                           
  TFile * inputFile = new TFile("twoCollapsedROOTNtuples/collapsedTree.root", "READ");
  ...
  TH1F * h1065  = new TH1F("h1065","Jet_DeltaPhi",100,0.,-5.0);
  TH1I * h1066  = new TH1I("h1066","Jet_Charge_1",100,0.,-5.0);
  TH1I * h1067  = new TH1I("h1067","Jet_Charge_2",100,0.,-5.0);
  ...
  */
  ...
  for (int entry = 0; entry < numberOfEntries; ++entry){
    ...
    if(type==1){
      ...
      h1065->Fill(Jet_DeltaPhi);
      h1066->Fill(Jet_Charge_1);
      h1067->Fill(Jet_Charge_2);
    }
  ...
  c1->cd(0);
  c1->Print("twoCollapsedROOTNtuples/TausByType.pdf");
  ...
  c2->cd(0);
  c2->Print("twoCollapsedROOTNtuples/MissByType.pdf");
  ...
  h65->Scale(1./h65->Integral()); h1065->Scale(1./h1065->Integral());
  h66->Scale(1./h66->Integral()); h1066->Scale(1./h1066->Integral());
  h67->Scale(1./h67->Integral()); h1067->Scale(1./h1067->Integral());
  ...
  c3->cd(16); h65->Draw("hist"); h1065->SetLineColor(kRed); h1065->Draw("hist same");
  c3->cd(17); h66->Draw("hist"); h1066->SetLineColor(kRed); h1066->Draw("hist same");
  c3->cd(18); h67->Draw("hist"); h1067->SetLineColor(kRed); h1067->Draw("hist same");
  c3->cd(0);
  c3->Print("twoCollapsedROOTNtuples/JetsByType.pdf");
