...
void byTypeHistogramsCollapse(){
  ...
  */
  ...
  c1->cd(0);
  c1->Print("collapsedROOTNtuples/TausByType.pdf");
  ...
  c2->cd(0);
  c2->Print("collapsedROOTNtuples/MissByType.pdf");
  ...
  c3->cd(0);
  c3->Print("collapsedROOTNtuples/JetsByType.pdf");
